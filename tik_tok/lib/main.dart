                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'envoyer votre video en cliquant sur ajouter',
                        style: TextStyle(
                          color: Colors.white,
                        ),
                      ),
                      ...
                      Row(
                        children: const [
                          ...
                          SizedBox(width: 5),
                          Text(
                            'Son original  orangedigitalkanson.com',
                            style: TextStyle(
                              color: Colors.white,
                            ),
                          ),
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      child: Container(
        ...
        child: Image.asset('assets/images/playe.png'),
      ),
    );
  }
}
